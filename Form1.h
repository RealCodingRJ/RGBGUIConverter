...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(63, 453);
			...
			this->label1->Location = System::Drawing::Point(132, 165);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(132, 229);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Arial", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(130, 288);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Arial", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(69, 419);
			...
			this->ClientSize = System::Drawing::Size(317, 517);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int randomR = r.Next(1, 255);
		int randomG = r.Next(1, 255);
		int randomB = r.Next(1, 255);

		this->label1->Text = System::Convert::ToString(randomR);
		this->label2->Text = System::Convert::ToString(randomG);
		this->label3->Text = System::Convert::ToString(randomB);

		this->Form1::BackColor = Color::FromArgb(randomR, randomG, randomB);
		this->label4->Text = randomR.ToString("X")
			+ randomG.ToString("X") + randomB.ToString("X");
